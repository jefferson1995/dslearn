...
//Classe auxiliar para definir a chave PK

/* 
 * Embeddabl: Utilizado para atributos compostos, ou seja, é utilizado na classe mãe Enrollment 
 *- Serve para qualquer atributo composto
 */
@Embeddable 
public class EnrollmentPK implements Serializable{
	private static final long serialVersionUID = 1L;
	
	//Duas referências para realizar  mapeamento para chave estrangeira
